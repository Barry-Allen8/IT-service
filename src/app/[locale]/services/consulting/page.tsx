      ...
      <section className="section bg-gradient-to-br from-primary/10 to-accent/10">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">{t("consulting.title")}</h1>
            <p className="text-xl text-muted mb-8">{t("consulting.hero_description")}</p>
            ...
            {benefits.map((key) => (
              <Card key={key}>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold mb-2">{t(`consulting.benefits.${key}.title`)}</h3>
                    <p className="text-muted text-sm">{t(`consulting.benefits.${key}.description`)}</p>
                  </div>
                </div>
              </Card>
            ))}
